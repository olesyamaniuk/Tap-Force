document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".tap-navigation-list");
  const headerRef = document.querySelector(".tap-header");
  const navigationRef = document.querySelector(".tap-navigation");
